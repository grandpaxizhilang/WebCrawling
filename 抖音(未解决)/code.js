...
try{
    ...
    function get_AB(data_){
        ...
        var ua = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36 Edg/123.0.0.0'
        // var result = window.chl(0,1,14,data_,'',ua)
        u = [0,1,14,data_,'',ua]
