...
Document.prototype.compatMode ='CSS1Compat'
...
Document.prototype.getElementById = function getElementById(id){
    ...
    if(id == "NECaptchaSafeWindow"){
        return catchvm.memory.HTMLElements['iframe']();
    }
...
Document.prototype.getElementsByTagName = function getElementsByTagName(name){
    ...
    if(name == 'meta'){
        console.log(arguments)
        return {
            '0':catchvm.memory.HTMLElements['meta'](),
            '1':catchvm.memory.HTMLElements['meta'](),
            '2':catchvm.memory.HTMLElements['meta'](),
            '3':catchvm.memory.HTMLElements['meta'](),
            '4':catchvm.memory.HTMLElements['meta'](),
            '5':catchvm.memory.HTMLElements['meta'](),
            '6':catchvm.memory.HTMLElements['meta'](),
            '7':catchvm.memory.HTMLElements['meta'](),
            '8':catchvm.memory.HTMLElements['meta'](),
            '9':catchvm.memory.HTMLElements['meta'](),
        }
    }
...
Document.prototype.createEvent = function createEvent(type){
    ...
    if(Type == 'touchevent' || 'PointerEvent'){
...
Object.getOwnPropertyDescriptor = function getOwnPropertyDescriptor(obj, prop){
    ...
    if(obj == navigator && prop == "platform"){
        console.log("检测了 ——> Object.getOwnPropertyDescriptor(navigator,'platform')")
        return undefined
    }
...
Object.getOwnPropertyDescriptors = function getOwnPropertyDescriptors(obj){
    ...
    if(obj == navigator){
        console.log("检测了 ——> Object.getOwnPropertyDescriptors(navigator)")
        return {}
    }
